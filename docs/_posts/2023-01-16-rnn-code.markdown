...
`l_grad` is the loss objective we're minimizing. If you wanted to experiment with other loss objectives, this is where you would plug in the gradient to see how they work.
